...
- turn decisions into durable artifacts
- slice work into independently claimable tickets
- implement only scoped, accepted work
- separate review measurement from repair execution
- ship only after review and validation evidence are clean
- specialize per repository without leaking another repository's domain
...
- The bundle is maintained as a system: skills, docs, lockfile, symlinks, semantic audit, and scenarios are validated together.
...
This repository is released under the MIT License. The license governs use of the code and documentation. The authorship record documents origin, method, and maintenance responsibility.
