...
When exploring the codebase, read `CONTEXT.md` (if it exists) to get a clear mental model of the relevant modules and repo boundaries, and check ADRs in the area you're touching.
