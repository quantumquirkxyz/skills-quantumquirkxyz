---
name: make-project
description: Use when the user wants a new board in GitHub Projects, or another skill needs one — create the project, wire its fields and views, link repositories, and populate it with items.
version: 1
capabilities:
  - create-project-v2
  - configure-fields
